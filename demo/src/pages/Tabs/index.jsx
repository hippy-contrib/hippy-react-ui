...
const Item = (props) => <Text style={{ height: props.height, lineHeight: props.height }} onLayout={props.onLayout} color={props.selected ? 'red' : 'green'}>2lksd</Text>;
		...
		return (
			<View style={{ flex: 1, padding: 12 }} onClick={() => history.goBack()}>
				<Tabs tabs={[
					...
					tabBarSelectedStyle={{ fontWeight: '100' }}
				>
				...
				<Tabs tabs={[
					...
					{ key: 't6', title: 't6sfadfasdfasdfasdfadsf' },
					{ key: 't7', title: 't7sfadfasdfasdfasdfadsf' },
				]} initialPage={'t2'}
					tabBarPosition='bottom'
					// onChange={page => console.log('onChange', page)}
					// onTabClick={() => console.log('onTabClick')}
				>
					<View style={{ backgroundColor: 'red', flex: 1, display: 'flex', justifyContent: 'center'}} key="t1">content1</View>
					<View key="t2">content2</View>
					<View key="t3">content3</View>
					<View key="t4">content4</View>
					<View key="t5">content5</View>
