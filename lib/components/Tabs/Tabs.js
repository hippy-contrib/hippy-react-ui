...
Tabs.propTypes = {
  ...
  initialPage: _props.tabPageProps,
  page: _props.tabPageProps,
  // 选中
  ...
  // 选中的颜色
  tabBarDividerColor: _propTypes.default.string // 默认下划线颜色，选中下划线颜色跟selectedColor一致
...
Tabs.defaultProps = {
  ...
  swipeable: true,
  showUnderLine: true,
  tabBarColor: _props.COLOR.textColor,
  tabBarSelectedColor: _props.COLOR.selectedTextColor,
  tabBarDividerColor: _props.COLOR.divider
};
var _default = Tabs;
