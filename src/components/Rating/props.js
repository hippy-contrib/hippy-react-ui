...
export const Props = {
	...
	defaultValue: PropTypes.number, // 默认分数, int类型，Math.floor 取整
	maxValue: PropTypes.number,  // 最大个数， int类型，Math.floor 取整
	editable: PropTypes.bool,  // 是否可以编辑
	onChange: PropTypes.func,  // 数值修改触发
	size: PropTypes.oneOfType([PropTypes.oneOf(fontSizes), PropTypes.number]),
	fontItem: PropTypes.string, // item的样式，文字表示
