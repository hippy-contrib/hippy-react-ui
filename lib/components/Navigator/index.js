...
function (_React$Component) {
  ...
  _createClass(Navigator, [{
    ...
    value: function renderLeft() {
      ...
      var body = _react.default.isValidElement(leftContent) ? leftContent :
      /*#__PURE__*/
    ...
    value: function renderRight() {
      ...
      return (
        ...
        }, _react.default.isValidElement(rightContent) ? rightContent :
        /*#__PURE__*/
        _react.default.createElement(_Text.default, {
          size: "sm"
        }, rightContent))
    ...
    value: function renderTitle() {
      ...
      return (
        ...
        }, _react.default.isValidElement(title) ? title :
        /*#__PURE__*/
        _react.default.createElement(_Text.default, {
          size: "md"
        }, title))
    ...
    value: function renderItem(pos, customContent) {
      ...
      return (
        ...
        _react.default.createElement(_react2.View, {
          style: style
        }, customContent || (!_react.default.isValidElement(body) ?
        /*#__PURE__*/
        _react.default.createElement(_Text.default, {
    ...
    value: function render() {
      ...
      return (
        /*#__PURE__*/
        _react.default.createElement(_StatusBarWrapper.default, null,
        /*#__PURE__*/
        _react.default.createElement(_react2.View, {
